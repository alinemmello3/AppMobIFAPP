        ...
        body: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Image.asset(
                'assets/images/login1.JPG', // Caminho para a imagem de fundo
                height: 200.0, // Altura da imagem
                fit: BoxFit
                    .cover, // Ajuste da imagem para cobrir toda a área verificar
              ),
              const SizedBox(
                  height:
                      20.0), // Espaçamento entre a imagem e os campos de entrada
              ...
              const SizedBox(
                  height: 10.0), // Espaçamento entre os campos de email e senha
              ...
              const SizedBox(
                  height:
                      20.0), // Espaçamento entre os campos de entrada e os botões de ação
              ...
              const SizedBox(
                  height: 20.0), // Espaçamento entre os botões de ação
